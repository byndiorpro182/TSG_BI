...
Module
01. CREATE DATABASE MART_MARKETING
02. CREATE TABLE LOG_ETL
03. CREATE TABLE FACT_SaleDetail
04. CREATE TABLE FACT_MarketingCosts
05. CREATE TABLE FACT_OppStatus
06. CREATE TABLE FACT_AdwordKeyword
07. CREATE TABLE FACT_TargetMarketing
08. CREATE TABLE DIM_Customer
09. CREATE TABLE DIM_Employee
10. CREATE TABLE DIM_IventoryItem
11. CREATE TABLE DIM_InventoryGroup
12. CREATE TABLE DIM_MarketingChannel
13. CREATE TABLE DIM_OppStatus
14. CREATE TABLE DIM_Calender
...
CREATE DATABASE MART_MARKETING
GO
...
CREATE TABLE FACT_MarketingCost
(
...
CREATE TABLE FACT_AdwordKeyword
(
	[Date] DATETIME NULL ,
...
CREATE TABLE FACT_TargetMarketing
(
...
(
	...
	[FromDate] DATETIME NULL ,
	[ToDate] DATETIME NULL ,
	[Insert/Update] NVARCHAR (255) NULL
)
GO
